...
public class BubbleSorterTest
{
    ...
    {
        Assertions.assertArrayEquals(new int[]{-2,-1,0,2}, BubbleSorter.getSortedArray(new int[]{2,0,-1,-2}));
    }
    ...
    {
        Assertions.assertArrayEquals(new int[]{-2,-1,0,2}, BubbleSorter.getSortedArray(new int[]{-2,-1,0,2}));
    }
    ...
    {
        Assertions.assertArrayEquals(new int[]{-9,-2,0,11,45}, BubbleSorter.getSortedArray(new int[]{-2,45,0,11,-9}));
    }
    ...
    {
        Assertions.assertArrayEquals(new int[]{}, BubbleSorter.getSortedArray(new int[]{}));
    }
