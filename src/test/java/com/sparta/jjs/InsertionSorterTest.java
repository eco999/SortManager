...
public class InsertionSorterTest {
    ...
    {
        Assertions.assertArrayEquals(new int[]{-2,-1,0,2}, insertionSorter.getSortedArray(new int[]{2,0,-1,-2}));
    }
    ...
    {
        Assertions.assertArrayEquals(new int[]{-2,-1,0,2}, insertionSorter.getSortedArray(new int[]{-2,-1,0,2}));
    }
    ...
    {
        Assertions.assertArrayEquals(new int[]{-9,-2,0,11,45}, insertionSorter.getSortedArray(new int[]{-2,45,0,11,-9}));
    }
    ...
    {
        Assertions.assertArrayEquals(new int[]{}, insertionSorter.getSortedArray(new int[]{}));
    }
}
